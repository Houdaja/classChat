 ...
 * SUJET
 *
 *  Vous travaillez pour la SPA. Dans le cadre de la refonte du site, vous devez créer une class Chat()
 qui aura les propriétés privées suivantes :
 ...
 *
 * Faire les getters/setters permettant de valider le type de données ci-dessus ainsi que le constructeur
 permettant d’instancier la classe.
 ...
 * Dans un nouveau fichier, instancier la classe afin de pouvoir afficher 3 chats différents et afficher
 le résultat à l’aide de la méthode getInfos() précédemment créée.
*/
